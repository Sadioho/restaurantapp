          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="right-0 top-12  w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute"
              >
                {user && user.email === 'hoxuananh9.3@gmail.com' && (
                  <Link to={'/createItem'}>
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col   ">
                <li className="px-4 py-2 hover:bg-slate-100 text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out">
                  Home
                </li>
                <li className="px-4 py-2 hover:bg-slate-100 text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out">
                  Menu
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-blue-400 gap-3 cursor-pointer hover:bg-red-400 transition-all duration-100 text-white text-base"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
