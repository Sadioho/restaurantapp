    ...
    <section className="w-full my-6" id="menu">
      <div className="w-full flex flex-col items-center justify-center">
        <p
          ...
          before:left-0 before:bg-gradient-to-tr from-green-400 to-green-600 transition-all 
          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                } w-24 min-w-[100px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col
                gap-3 items-center justify-center hover:bg-cartNumBg duration-150 transition-all ease-in-out`}
